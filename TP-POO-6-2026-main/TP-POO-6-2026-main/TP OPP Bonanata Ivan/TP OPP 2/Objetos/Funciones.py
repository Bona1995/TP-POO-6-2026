...
from Objetos.UsuarioAdmin import UsuarioAdmin
from Objetos.Insumo import Insumo      
from Objetos.Productos import Producto
...
def cargar_datos_prueba():
    ...
    cursor = conexion.cursor()
    try:
        cursor.execute("SELECT id_usuario_admin FROM usuarios WHERE dni = 39123456")
        ...
        print("eRROR DE CARGA, ELEMENTOS DUPLICADOS")
    finally:
        conexion.close()
...
def menu_principal():
    ...
    print("Binevenido al sistema de gestion PYME. ")
    cargar_datos_prueba()
    
    while True:
        print("   MENÚ DE GESTIÓN PYME ")
        ...
        match opcionMatch:
            ...
            case "2":
                print("2. Mostrar Todos los Usuarios \n")
                resultadoMostrarUsuarios = mostrar_todos_los_usuario()
                print(f"{resultadoMostrarUsuarios}\n")
            case "3":
                print("3. Buscar Usuario por ID \n")
                resultadoBuscarUsuario = mostrar_usuario(id_usuario)
            ...
            case "5":
                print("5. Mostrar Todos los Insumos \n")
                resultadoMostrarInsumos = mostrar_todos_los_insumos()
                print(f"{resultadoMostrarInsumos}\n")
            case "6":
                print("6. Buscar Insumo por ID \n")
                resultadoBuscarInsumo = mostrar_insumo(id_insumo)
            ...
            case "8":
                print("8. Mostrar Todos los Productos \n")
                resultadoMostrarProductos = mostrar_todos_los_productos()
                print(f"{resultadoMostrarProductos}\n")
            case "9":
                print("9. Buscar Producto por ID \n")
                resultadoBuscarProducto = mostrar_producto(id_producto)
